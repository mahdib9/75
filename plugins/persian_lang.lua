...
local function run(msg, matches)
    if permissions(msg.from.id, msg.to.id, "lang_install") then
        ...
        set_text(LANG, 'commands:1', '!help: نمایش دستورات تمامی پلاگین ها.')
        set_text(LANG, 'commands:2', '!Help [plugin]: نمایش دستورات پلاگین مورد نظر.')
        ...
        set_text(LANG, 'export_gban:2', '1gbans list: ارسال لیست بن های سراسری .')
